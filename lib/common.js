...
exports.globals = {
  ...
  BASE_SERVICE : 'base', 
  UTILS_SERVICE : 'utils', 
  CANVAS_KEYS_DIRECTIVE : 'canvaskeys',

  // hash lookup for artifact names
  // artifactNameLookup : {
  //   'mainCtrl' : MAIN_CTRL,
  //   'mainService' : MAIN_SERVICE,
  //   'baseService' : BASE_SERVICE,
  //   'utilsService' : UTILS_SERVICE,
  //   'canvasKeysDirective' : CANVAS_KEYS_DIRECTIVE,
  // },
  //vt end
};
*/
...
globalObj.fileUpdatedTag = 'webvr-decorator-> file updated on: ';
globalObj.CODE_COMMENTED_BEGIN_TAG = 'webvr-decorator-> code commented out on: ';
globalObj.CODE_COMMENTED_END_TAG = 'webvr-decorator-> end code commenting';
globalObj.MAIN_CTRL = 'main'; 
globalObj.MAIN_SERVICE = 'main'; 
globalObj.BASE_SERVICE = 'base'; 
globalObj.UTILS_SERVICE = 'utils'; 
globalObj.CANVAS_KEYS_DIRECTIVE = 'canvaskeys';

globalObj.artifactNameLookup = {};
globalObj.artifactNameLookup.mainCtrl = globalObj.MAIN_CTRL;
globalObj.artifactNameLookup.mainService = globalObj.MAIN_SERVICE;
globalObj.artifactNameLookup.baseService = globalObj.BASE_SERVICE;
globalObj.artifactNameLookup.utilsService = globalObj.UTILS_SERVICE;
globalObj.artifactNameLookup.canvasKeysDirective = globalObj.CANVAS_KEYS_DIRECTIVE;

exports.globals = globalObj;
//vt end
...
exports.getLibList = function (dir, cb) {
  ...
  if (fs_node.existsSync(dir)) {
    ...
    // call the original client without doing anything
    cb('', []);
  }
};
